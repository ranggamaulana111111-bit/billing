...
class PackageTest extends TestCase
{
    ...
    {
        $package = Package::factory()->create(['tenant_id' => $this->user->tenant_id, 'name' => 'Old Name']);
    ...
    {
        Package::factory()->create(['tenant_id' => $this->user->tenant_id, 'name' => 'Home Fiber 10', 'is_active' => true]);
        Package::factory()->create(['tenant_id' => $this->user->tenant_id, 'name' => 'Legacy Radio', 'is_active' => false]);
    ...
    {
        $package = Package::factory()->create(['tenant_id' => $this->user->tenant_id]);
        Customer::factory()->create(['tenant_id' => $this->user->tenant_id, 'package_id' => $package->id]);
