...
class CustomerTest extends TestCase
{
    ...
    {
        $package = Package::factory()->create(['tenant_id' => $this->user->tenant_id, 'price' => 150000]);
    ...
    {
        $package = Package::factory()->create(['tenant_id' => $this->user->tenant_id]);
        $customer = Customer::factory()->create(['tenant_id' => $this->user->tenant_id, 'package_id' => $package->id, 'name' => 'Old Name']);
    ...
    {
        $package = Package::factory()->create(['tenant_id' => $this->user->tenant_id]);
        $customer = Customer::factory()->create(['tenant_id' => $this->user->tenant_id, 'package_id' => $package->id, 'status' => 'active']);
    ...
    {
        $package = Package::factory()->create(['tenant_id' => $this->user->tenant_id]);
        $customer = Customer::factory()->create(['tenant_id' => $this->user->tenant_id, 'package_id' => $package->id, 'status' => 'suspended']);
