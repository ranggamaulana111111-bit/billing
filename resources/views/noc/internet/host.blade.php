...
@section('title', 'Hotspot Hosts — Internet Service Center')
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1" style="font-size:0.78rem;">
                ...
                <li class="breadcrumb-item active">Hotspot Hosts</li>
            </ol>
        </nav>
        <h2 class="mb-0"><i class="fa-solid fa-desktop me-2" style="color:var(--primary);"></i>Hotspot Hosts</h2>
        <p class="section-subtitle mb-0 mt-1">{{ $router->display_identity ?? 'No router' }} · {{ count($items) }} hosts</p>
    </div>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="text-muted" style="font-size:0.75rem;">Total Hosts</div>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body py-3">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-3">
                <input type="text" id="searchInput" class="form-control form-control-sm" placeholder="Search hosts..." onkeyup="filterTable()">
            </div>
        </form>
    </div>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="5" class="text-center text-muted py-4">
                            <i class="fa-solid fa-desktop" style="font-size:2rem;"></i>
                            <p class="mt-2 mb-0">No hotspot hosts detected</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
