...
@section('title', 'Audit Logs — Traffic Engineering')
...
<div class="page-header d-flex flex-wrap justify-content-between align-items-center mb-4">
    <div>
        ...
        <h2 class="mb-0"><i class="fa-solid fa-clipboard-list me-2" style="color:#6b7280;"></i>Traffic Engineering Audit Logs</h2>
    </div>
</div>

@if(session('success'))
<div class="alert alert-success alert-dismissible fade show mb-4 py-2" style="font-size:0.85rem;"><i class="fa-solid fa-circle-check me-2"></i>{{ session('success') }}<button type="button" class="btn-close btn-close-sm" data-bs-dismiss="alert"></button></div>
@endif
        ...
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-3">
                ...
                <select name="resource_type" class="form-select form-select-sm" onchange="this.form.submit()">
                    ...
                    @foreach(['simple_queue' => 'Simple Queue', 'queue_tree' => 'Queue Tree', 'queue_type' => 'Queue Type'] as $k => $v)
            ...
            <div class="col-md-3 d-flex gap-1">
                ...
                <a href="{{ route('noc.traffic_eng.audit') }}" class="btn btn-outline-secondary btn-sm">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<table class="table table-hover align-middle mb-0 mon-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-light text-dark" style="font-size:0.65rem;">{{ str_replace('traffic_eng.', '', $log->resource_type) }}</span></td>
    ...
    <div class="card-footer bg-transparent border-0 text-muted" style="font-size:0.8rem;">
        <i class="fa-solid fa-info-circle me-1"></i>Showing {{ $logs->count() }} logs (max 30 per query)
    </div>
    @endif
</div>
@endsection
